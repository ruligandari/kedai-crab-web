                                ...
                                <tbody>
                                    ...
                                    <?php foreach ($data_transaksi as $item) : ?>
                                        <tr>
                                            ...
                                            <td><?= $item['nama'] ?? 'belum ada kurir' ?></td>
                                            <td>
                                                <button role="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#pilihKurir<?= $item['id'] ?>"><i class="bi bi-truck"></i></button>
                                            </td>
                                        </tr>
                                    <?php endforeach ?>
                                </tbody>
...
<?php foreach ($data_transaksi as $item) : ?>
    <div class="modal fade" id="pilihKurir<?= $item['id'] ?>" tabindex="-1">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p>Pilih kurir untuk no transaksi <?= $item['no_transaksi'] ?></p>
                    <form action="<?= base_url('kasir/pilih-kurir') ?>" method="post">
