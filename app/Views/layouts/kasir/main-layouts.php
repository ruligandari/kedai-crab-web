...
<body>
  ...
  <aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link <?= ($title == 'Dashboard') ? '' : 'collapsed' ?>" href="<?= base_url('kasir/dashboard') ?>">
      ...
      <li class="nav-item">
        <a class="nav-link <?= ($title == 'List Pesanan') ? '' : 'collapsed' ?>" href="<?= base_url('kasir/list-pesanan') ?>">
