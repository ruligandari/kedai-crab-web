...
<body>
  ...
  <aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link <?= ($title == 'List Menu') ? '' : 'collapsed' ?>" href="<?= base_url('pemilik/list-menu') ?>">
      ...
      <li class="nav-item">
        <a class="nav-link <?= ($title == 'List Transaksi') ? '' : 'collapsed' ?>" href="<?= base_url('pemilik/list-transaksi') ?>">
